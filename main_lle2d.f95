...
read *,theta
a=0
!a=reshape((/0,1,1,-1,0,1,-1,-2,0/),(/3,3/))
a(1,2)=1
a(1,3)=1
a(2,1)=-1
a(2,3)=1
...
ffixed=(1./2)*reshape((/1,-1,0,-1,2,-1,0,-1,1/),(/3,3/))
...
fl=jacobian(x(1:2,i1),x(1:2,i2),x(1:2,i3))*ffixed
...
a1(i1,i1)=a1(i1,i1)+a1l(1,1)
a1(i1,i2)=a1(i1,i2)+a1l(1,2)
a1(i1,i3)=a1(i1,i3)+a1l(1,3)
a1(i2,i1)=a1(i2,i1)+a1l(2,1)
a1(i2,i2)=a1(i2,i2)+a1l(2,2)
a1(i2,i3)=a1(i2,i3)+a1l(2,3)
a1(i3,i1)=a1(i3,i1)+a1l(3,1)
a1(i3,i2)=a1(i3,i2)+a1l(3,2)
a1(i3,i3)=a1(i3,i3)+a1l(3,3)

end do

a1(1:n,n+1:2*n)=a1(1:n,1:n)
a1(n+1:2*n,1:n)=a1(1:n,1:n)
a1(n+1:2*n,n+1:2*n)=a1(1:n,1:n)

do i=1,n
do j=1,n
a1(i,j)=dot_prod(b1(:,j),b1(:,i))*a1(i,j)
a1(i+n,j)=dot_prod(b1(:,j),b2(:,i))*a1(i+n,j)
a1(i,j+n)=dot_prod(b2(:,j),b1(:,i))*a1(i,j+n)
a1(i+n,j+n)=dot_prod(b2(:,j),b2(:,i))*a1(i+n,j+n)
end do
end do
...
a2l=jacobian(x(1:2,i1),x(1:2,i2),x(1:2,i3))*a2fixed

a2(i1,i1)=a2(i1,i1)+a2l(1,1)
a2(i1,i2)=a2(i1,i2)+a2l(1,2)
a2(i1,i3)=a2(i1,i3)+a2l(1,3)
a2(i2,i1)=a2(i2,i1)+a2l(2,1)
a2(i2,i2)=a2(i2,i2)+a2l(2,2)
a2(i2,i3)=a2(i2,i3)+a2l(2,3)
a2(i3,i1)=a2(i3,i1)+a2l(3,1)
a2(i3,i2)=a2(i3,i2)+a2l(3,2)
a2(i3,i3)=a2(i3,i3)+a2l(3,3)

end do

a2(1:n,n+1:2*n)=a2(1:n,1:n)
a2(n+1:2*n,1:n)=a2(1:n,1:n)
a2(n+1:2*n,n+1:2*n)=a2(1:n,1:n)
e_matrix=a2(1:n,1:n)

do i=1,n
do j=1,n
a2(i,j)=dot_prod(b1(:,j),b1(:,i))*a2(i,j)
a2(i+n,j)=dot_prod(b1(:,j),b2(:,i))*a2(i+n,j)
a2(i,j+n)=dot_prod(b2(:,j),b1(:,i))*a2(i,j+n)
a2(i+n,j+n)=dot_prod(b2(:,j),b2(:,i))*a2(i+n,j+n)
end do
end do
...
a3(i2,i2+n)=a3(i2,i1+n)+dc_prod(b2(:,i2),b1(:,i2),m(:,i1))*a3l1(2,2)+dc_prod(b2(:,i2),b1(:,i2),m(:,i2))*a3l2(2,2)+dc_prod(b2(:,i2),b1(:,i2),m(:,i3))*a3l3(2,2)
a3(i2,i3+n)=a3(i2,i1+n)+dc_prod(b2(:,i3),b1(:,i2),m(:,i1))*a3l1(2,3)+dc_prod(b2(:,i3),b1(:,i2),m(:,i2))*a3l2(2,3)+dc_prod(b2(:,i3),b1(:,i2),m(:,i3))*a3l3(2,3)
...
a3(i2+n,i2)=a3(i2+n,i1)+dc_prod(b1(:,i2),b2(:,i2),m(:,i1))*a3l1(2,2)+dc_prod(b1(:,i2),b2(:,i2),m(:,i2))*a3l2(2,2)+dc_prod(b1(:,i2),b2(:,i2),m(:,i3))*a3l3(2,2)
a3(i2+n,i3)=a3(i2+n,i1)+dc_prod(b1(:,i3),b2(:,i2),m(:,i1))*a3l1(2,3)+dc_prod(b1(:,i3),b2(:,i2),m(:,i2))*a3l2(2,3)+dc_prod(b1(:,i3),b2(:,i2),m(:,i3))*a3l3(2,3)
...
a3(i2+n,i2+n)=a3(i2+n,i1+n)+dc_prod(b2(:,i2),b2(:,i2),m(:,i1))*a3l1(2,2)+dc_prod(b2(:,i2),b2(:,i2),m(:,i2))*a3l2(2,2)+dc_prod(b2(:,i2),b2(:,i2),m(:,i3))*a3l3(2,2)
a3(i2+n,i3+n)=a3(i2+n,i1+n)+dc_prod(b2(:,i3),b2(:,i2),m(:,i1))*a3l1(2,3)+dc_prod(b2(:,i3),b2(:,i2),m(:,i2))*a3l2(2,3)+dc_prod(b2(:,i3),b2(:,i2),m(:,i3))*a3l3(2,3)
...
do i=1,n
do j=1,n
e_matrix(i,j)=dot_prod(m0(:,i),m0(:,j))*e_matrix(i,j)
!e_matrix(i+n,j)=dot_prod(m0(:,i),m0(:,j))*e_matrix(i+n,j)
!e_matrix(i,j+n)=dot_prod(m0(:,i),m0(:,j))*e_matrix(i,j+n)
!e_matrix(i+n,j+n)=dot_prod(m0(:,i),m0(:,j))*e_matrix(i+n,j+n)
end do
end do
...
!do i=1,n
!do j=1,n
!e_matrix(i,j)=dot_prod(m(:,i),m(:,j))*e_matrix(i,j)
!end do
!end do
